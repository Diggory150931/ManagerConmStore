                    ...
                    <div class="row">
                        <div class="col-md-6 mb-5">
                            ...
                            <div class="d-flex flex-column justify-content-start">
                                <a class="text-dark mb-2" href="customer#product"
                                   ><i class="fa fa-angle-right mr-2"></i>Shop</a
                                >

                                <a class="text-dark mb-2" href="Cart.jsp"
                                   ><i class="fa fa-angle-right mr-2"></i>Shopping Cart</a
                                >
                                <a class="text-dark mb-2" href="https://www.pinterest.com/pin/422281210416066/"
            ...
            <div class="row border-top border-light mx-xl-5 py-4">
                <div class="col-md-6 px-xl-0">
                    <p class="mb-md-0 text-center text-md-left text-dark">
                        &copy;
                        <a class="text-dark font-weight-semi-bold" href="#">nDuCaComputer</a>.
                        All Rights Reserved.
